...
import { Credenza, CredenzaContent } from "@/components/credenza";
  ...
  return (
    <>
      ...
      <Button
        variant="outline"
        className={cn(
          "relative hidden h-8 w-full justify-start rounded-[0.5rem] bg-background text-sm font-normal text-muted-foreground shadow-none sm:pr-12 md:flex md:w-40 lg:w-64",
        )}
        onClick={() => setIsOpen(true)}
      >
        ...
        <CredenzaContent className="overflow-hidden p-0">
          <Command className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-group]]:px-2 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5">
            ...
            <CommandList>
              ...
              <CommandGroup
                className="block capitalize md:hidden"
                heading="Pages"
              >
                {Pages.map(
                  (page) =>
                    page.path && (
                      <CommandItem
                        ...
                        className="h-9 cursor-pointer rounded-lg text-sm"
                      >
              ...
              <CommandGroup className="block md:hidden" heading="Theme">
                <CommandItem className="h-9 cursor-pointer rounded-lg">
